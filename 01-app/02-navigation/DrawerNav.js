...
import { View, Text, SafeAreaView, StyleSheet, Image, ImageBackground, TouchableOpacity, FlatList, TextInput, Alert, Switch } from "react-native";
...
const DrawerNav = ({ props, route, navigation }) => {
    ...
    if(isEnabled == false){
        ...
        setIsEnabled(false)
         ...
         AsyncStorage.setItem('Language', 'Francais')
    }
    getAsyncStorageData()
    }
                ...
                <View style={globalStyles.menuModal_style}>
                    <View style={{ margin: 30, width: '100%', flexDirection: 'row' }}>
                        ...
                        <View style={{ alignItems: 'center', width: '70%' }}>
                            <Image source={require('../../assets/famulous_logo.png')} style={globalStyles.home_famulous_logo_Drawer}></Image>
                        </View>
                    ...
                    {userUid != "" ? (
                        ...
                        />
                    ) : <Image source={require('../../assets/user.png')} style={globalStyles.home_famulous_logo_Drawer_byDefault}></Image>
                    ...
                    >
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('MyProfilePage')}>
                            <View style={{ width: '100%' }}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_myprofile_icon.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('Root')}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_myJournals_icon.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('JoinJournalsPage')}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_joinJournal_icon.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('SubscriptionPage')}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_subscription_icon.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('HowItWorksPage')}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_howitworks_icon.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => navigateTo('SupportPage')}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_support_icon.png')} style={globalStyles.Drawer_icons}></Image>
                            ...
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/france.png')} style={globalStyles.Drawer_icons}></Image>
                                    <Switch
                                    ...
                                    />
                                    <Image source={require('../../assets/united-kingdom.png')} style={globalStyles.Drawer_icons}></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => alertLogout()}>
                            <View style={globalStyles.drawer_row_div}>
                                <View style={globalStyles.drawer_row_item}>
                                    <Image source={require('../../assets/drawer_signout_icon.png')} style={globalStyles.Drawer_icons}></Image>
                    ...
                    <View style={globalStyles.side_menu_footer}>
                        <TouchableOpacity activeOpacity={0.8} onPress={() => scroll()} style={{ width: '100%' }}>
