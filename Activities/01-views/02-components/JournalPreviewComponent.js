        ...
        return <View style={globalStyles.journal_upload_item_view_portrait_50pourcent_withoutborder}>
            ...
            <View style={globalStyles.portrait_2ndView50}>
                ...
                <View style={globalStyles.portrait_description}>
                    <Text style={{fontSize:9 ,fontWeight:this.props.fontWeight, fontStyle:this.props.fontStyle, textDecorationLine:this.props.textDecoration, color:this.props.textDescColor}}>{this.props.imgDescription}</Text>
                </View>
            </View>
        </View>
    }
    ...
    render() {
        return <View style={{ width: '100%', height: '97%' }}>
            <View style={globalStyles.journal_Preview_portraitFullScreen}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', bottom: 65}}>
                    <Text style={{fontSize:9 ,fontWeight:this.props.fontWeight, fontStyle:this.props.fontStyle, textDecorationLine:this.props.textDecoration, color:this.props.textDescColor}}>{this.props.imgDescription}</Text>
                </View>
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', bottom: 45 }}>
                    <View>
                        <FastImage
                            style={globalStyles.imageRounded40}
                            source={{
...
export class DescriptionFullViewOnlyComponent extends React.Component {
    render() {
        return <View style={{ width: '100%', height: '97%' }}>
            <View style={globalStyles.journal_Preview_portraitFullScreen}>
                <View style={{ height: 500 }}>
                    <View style={{display:'flex',height:400, justifyContent:'center'}} >
                    <Text style={globalStyles.journal_text_styles_description_purple_Preview}>{this.props.imgDescription}</Text>
                    </View>
                </View>
...
export class DescriptionViewOnlyComponent extends React.Component {
    render() {
        return <View style={globalStyles.journal_upload_item_view_landscape_50pourcent_withoutborder}>
            <View style={globalStyles.landscape_width50_column_withoutDesc_DescriptionOnly}>
                <View style={globalStyles.landscape_width100_preview_withoutDesc_DescriptionOnly}>
                    <Text style={globalStyles.journal_text_styles_description_purple_Preview}>{this.props.imgDescription}</Text>
                </View>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', bottom: 100,justifyContent:'center' }}>
                <View>
                    <FastImage
                        style={globalStyles.imageRounded40}
                        source={{
