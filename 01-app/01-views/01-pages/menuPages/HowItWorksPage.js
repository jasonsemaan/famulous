                ...
                <View style={globalStyles.menuDrawer_Overflow_Div}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={{ flex: 1, alignItems: 'center' }}>
                            ...
                            <View style={globalStyles.howitworks_single_view}>
                                <Image source={require('../../../../assets/howitworks_img1.png')} style={globalStyles.howitworks_images_style}></Image>
                            </View>
                            ...
                            <View style={globalStyles.howitworks_single_view}>
                                <Image source={require('../../../../assets/howitworks_img2.png')} style={globalStyles.howitworks_images_style}></Image>
                            </View>
                            <View style={globalStyles.howitworks_single_view_noMargins}>
                                <Text style={globalStyles.howitworks_smallText}>
                                    {atTheEndOfTheMonth}
                            ...
                            <View style={globalStyles.howitworks_single_view}>
                                <Image source={require('../../../../assets/howitworks_img3.png')} style={globalStyles.howitworks_images_style}></Image>
                            </View>
                            <View style={globalStyles.howitworks_single_view_noMargins}>
                                <Text style={globalStyles.howitworks_smallText}>
                                    {afterProcessing}
                            ...
                            <View style={{ width: '100%', marginTop: 20, padding: 20 }}>
                                ...
                                <View style={{ flexDirection: 'row', width: '100%', padding: 20 }}>
                                    ...
                                    <View style={{ width: '20%' }}>
                                        <Image source={require('../../../../assets/howitworks_img4.png')} style={globalStyles.howitworks_images_style}></Image>
                                    </View>
                                </View>
                            </View>
